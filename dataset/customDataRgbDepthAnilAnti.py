...
class customData(Dataset):
    def __init__(self, img_path, txt_path, phase = '',data_transforms_color=None, data_transforms_depth=None, color_loader = default_rgb_loader, depth_loader = default_depth_loader):
    ...
    def __getitem__(self, item):
        try:
            ...
            rgb_img = self.color_loader(img_name)
...
class customTargetData(Dataset):
    def __init__(self, img_path, txt_path, phase = '',data_transforms_color=None, data_transforms_depth=None, color_loader = default_rgb_loader):
        with open(txt_path) as input_file:
            lines = input_file.readlines()
            random.Random(4).shuffle(lines)
            self.img_name = []
