...
from dataset.customDataAnilAntiSupConvCatAug import customData
...
def fast_adapt_supcon(batch,
    ...
    valid_error_sup_conv = loss_supcon(evalulation_data_cat, evaluation_labels)
...
def main(args):
    ...
    train_dataset = customData(img_path=args.data_path,
                                    ...
                                    data_transforms_aug = pre_processRGB_aug,
                                    phase="meta_train")
