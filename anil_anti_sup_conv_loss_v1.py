'''
cross entropy, contrastive 前沒加 Normalize，Log 不詳細，但分數最高
'''
...
def fast_adapt_supcon(batch,
    ...
    valid_error = loss_supcon(evaluation_feats, evaluation_labels) + loss_cross(predictions, evaluation_labels)
...
def main(args
        ...
        # cuda=1,
        # seed=42,
        # data_path='../../sinica/CelebA_Data/trainSquareCropped',
        # txt_path='../../sinica/CelebA_Data/metas/intra_test/train_label.txt',
):
    ...
    for iteration in range(args.iters):#20000
        ...
        for task in range(args.meta_bsz):#32
            ...
            evaluation_error, evaluation_accuracy = fast_adapt_supcon(batch,
                                                               learner,
                                                               features,
                                                               loss_supcon,
                                                               loss_cross,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--results_path', type=str, default="output/anil_anti__sup_conv_loss/", metavar='S',
                        help='output dir')
