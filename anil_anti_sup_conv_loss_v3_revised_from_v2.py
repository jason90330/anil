...
class FeatExtr(nn.Module):
    ...
    def __init__(self, feat_dim=128):
        ...
        out_feature = self.encoder._fc.in_features
...
def fast_adapt_supcon(batch,
    ...
    for step in range(adaptation_steps):
        ...
        train_error_sup_conv = loss_sup_conv(adaptation_data, adaptation_labels)
    ...
    # valid_error_sup_conv = loss_sup_conv(evaluation_data, evaluation_labels, hard_pairs)
    valid_error_sup_conv = loss_sup_conv(evaluation_data, evaluation_labels)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--results_path', type=str, default="output/anil_anti_sup_conv_loss_v3_both_inner_outer_revised_from_v2/", metavar='S',
                        help='output dir')
