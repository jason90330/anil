...
from misc.test import Test, TestOri, TestReg
...
def fast_adapt(batch,
    ...
    # evaluation_feats = F.normalize(evaluation_data)
    ...
    return valid_error_cross, valid_accuracy
...
def main(args):
    ...
    features = regnety("400MF", pretrained=True, cfg_list=("MODEL.NUM_CLASSES", 1000))
    ...
    for iteration in range(args.iters):#20000
        ...
        for task in range(args.meta_bsz):#32
            ...
            valid_error_cross, evaluation_accuracy = fast_adapt(batch,
                                                               learner,
                                                               features,
                                                               loss_cross,
                                                               args.adapt_steps,
                                                               ...
                                                               args.ways,
                                                               device)
            valid_error_cross.backward()
            meta_train_error += valid_error_cross.item()
            ...
            valid_error_cross, evaluation_accuracy = fast_adapt(batch,
                                                               ...
                                                               args.ways,
                                                               device)            
            meta_valid_error += valid_error_cross.item()
            ...
            valid_error_cross, evaluation_accuracy = fast_adapt(batch,
                                                               ...
                                                               args.ways,
                                                               device)            
            meta_test_error += valid_error_cross.item()
        ...
        if iteration<100 or iteration%500==0:
            TestReg(args, features, learner, test_data_loader, iteration)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--results_path', type=str, default="output/anil_anti_regnet/", metavar='S',
                        help='output dir')
