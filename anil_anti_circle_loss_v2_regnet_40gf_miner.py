...
def fast_adapt(batch,
    ...
    hard_pairs = miner(evaluation_feats, evaluation_labels)
    valid_error_circle = loss_circle(evaluation_feats, evaluation_labels, hard_pairs)
...
def main(args):
    ...
    features = regnety("4.0GF", pretrained=True, cfg_list=("MODEL.NUM_CLASSES", 1000))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--results_path', type=str, default="output/anil_anti_circle_v2_regnet_40gf/", metavar='S',
                        help='output dir')
